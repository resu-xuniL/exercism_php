...
class VariableLengthQuantityTest extends TestCase
{
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesZero(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesArbitrarySingleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesAsymmetricSingleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesLargestSingleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesSmallestDoubleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesArbitraryDoubleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesAsymmetricDoubleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesLargestDoubleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesSmallestTripleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesArbitraryTripleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesAsymmetricTripleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesLargestTripleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesSmallestQuadrupleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesArbitraryQuadrupleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesAsymmetricQuadrupleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesLargestQuadrupleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesSmallestQuintupleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesArbitraryQuintupleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesAsymmetricQuintupleByte(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesMaximum32BitIntegerInput(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesTwoSingleByteValues(): void
    {
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesTwoMultiByteValues(): void
    {
        $this->assertEquals(
    ...
    public function testEncodeASeriesOfIntegersProducingASeriesOfBytesManyMultiByteValues(): void
    {
        $this->assertEquals(
            [
                0xC0, 0x00,
    ...
    public function testDecodeASeriesOfBytesProducingASeriesOfIntegersOneByte(): void
    {
